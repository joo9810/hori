...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.phi.modeling_phi import (Callable, Optional, Union, torch, nn, ACT2FN, Cache, GenerationMixin, BaseModelOutputWithPast, CausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, TransformersKwargs, can_return_tuple, deprecate_kwarg, PhiConfig, logger, __name__, PhiPreTrainedModel, PhiModel, PhiForCausalLM)
...
class PhiAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return PhiAttention_forward(self, hidden_states, position_embeddings, attention_mask, past_key_values, cache_position, **kwargs)
...
class PhiForCausalLM(PhiPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return PhiForCausalLM_forward(self, input_ids, attention_mask, position_ids, past_key_values, inputs_embeds, labels, use_cache, cache_position, logits_to_keep, **kwargs)
