...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.exaone4.modeling_exaone4 import (__name__, Callable, Optional, Union, torch, nn, ACT2FN, Cache, GenerationMixin, use_kernel_forward_from_hub, BaseModelOutputWithPast, CausalLMOutputWithPast, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, TransformersKwargs, can_return_tuple, deprecate_kwarg, Exaone4Config, Exaone4PreTrainedModel, Exaone4Model, Exaone4ForCausalLM)

@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
def Exaone4RMSNorm_forward(self, hidden_states):
...
class Exaone4RMSNorm(nn.Module):
    ...
    def forward(self, hidden_states):
        return Exaone4RMSNorm_forward(self, hidden_states)
...
def Exaone4RotaryEmbedding_forward(self, x, position_ids):
...
class Exaone4RotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids):
        return Exaone4RotaryEmbedding_forward(self, x, position_ids)
...
class Exaone4Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return Exaone4Attention_forward(self, hidden_states, position_embeddings, attention_mask, past_key_values, cache_position, **kwargs)


@torch.compile(fullgraph = False, dynamic = True, options = torch_compile_options)
def Exaone4MLP_forward(self, x):
...
class Exaone4MLP(nn.Module):
    ...
    def forward(self, x):
        return Exaone4MLP_forward(self, x)


@torch.compiler.disable(recursive = False)
@can_return_tuple
def Exaone4ForCausalLM_forward(
    self,
...
class Exaone4ForCausalLM(Exaone4PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        return Exaone4ForCausalLM_forward(self, input_ids, attention_mask, position_ids, past_key_values, inputs_embeds, labels, use_cache, cache_position, logits_to_keep, **kwargs)
